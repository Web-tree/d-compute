...
type ConnectionStatus struct {
	...
	ConnectedPeersAmount int32    `protobuf:"varint,2,opt,name=connectedPeersAmount,proto3" json:"connectedPeersAmount,omitempty"`
...
func (m *ConnectionStatus) GetConnectedPeersAmount() int32 {
	if m != nil {
		return m.ConnectedPeersAmount
	}
	return 0
}
...
var fileDescriptor_51baa40a1cc6b48b = []byte{
	...
	0x01, 0x33, 0x92, 0xf3, 0x73, 0x94, 0x52, 0xb8, 0x04, 0x9c, 0xe1, 0xf2, 0xc1, 0x25, 0x89, 0x25,
	0xa5, 0xc5, 0x42, 0x32, 0x5c, 0x9c, 0x50, 0x3d, 0xa9, 0x29, 0x12, 0x8c, 0x0a, 0x8c, 0x1a, 0x1c,
	0x41, 0x08, 0x01, 0x21, 0x23, 0x2e, 0x11, 0x38, 0x27, 0x20, 0x35, 0xb5, 0xa8, 0xd8, 0x31, 0x37,
	0xbf, 0x34, 0xaf, 0x44, 0x82, 0x49, 0x81, 0x51, 0x83, 0x35, 0x08, 0xab, 0x9c, 0x13, 0xcf, 0x89,
	0x47, 0x72, 0x8c, 0x17, 0x1e, 0xc9, 0x31, 0x3e, 0x78, 0x24, 0xc7, 0x98, 0xc4, 0x06, 0xb6, 0xdd,
	0x18, 0x10, 0x00, 0x00, 0xff, 0xff, 0xf4, 0xed, 0x44, 0xdd, 0x9a, 0x00, 0x00, 0x00,
}
...
func (m *ConnectionStatus) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.ConnectedPeersAmount != 0 {
		i = encodeVarintConnection(dAtA, i, uint64(m.ConnectedPeersAmount))
		i--
		dAtA[i] = 0x10
	}
	if m.Connected {
...
func (m *ConnectionStatus) Size() (n int) {
	...
	if m.ConnectedPeersAmount != 0 {
		n += 1 + sovConnection(uint64(m.ConnectedPeersAmount))
	}
	if m.XXX_unrecognized != nil {
...
func (m *ConnectionStatus) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ConnectedPeersAmount", wireType)
			}
			m.ConnectedPeersAmount = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowConnection
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ConnectedPeersAmount |= int32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
